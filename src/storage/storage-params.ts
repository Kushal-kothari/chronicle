...
export function getDefaultValue(param: StorageParams) {
  switch (param) {
    ...
    case StorageParams.CATEGORY_OVERRIDES:
      return {};
    case StorageParams.GOALS:
      return [];
    case StorageParams.FOCUS_SESSIONS:
      return [];
    case StorageParams.ACTIVE_FOCUS_SESSION:
      return null;
